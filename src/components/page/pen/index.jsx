    ...
    <>
      <div>
        ...
        <div className="scrollList">
          ...
          />
          <GlobalForm handleSubmit={handleSubmit} reset={reset} url={'window-handlers'} onedataId={onedataId}>
            <AddInput
              type={"text"}
            ...
            <AddInput
              ...
              value={watchedFiles?.profile_color_id || "цвет"}
            />
            <AddInput
              type={"number"}
              placeholder={"0.0"}
          ...
          </GlobalForm>
          {
            ...
            />)}
          <DeleteModal url={"window-handlers"} />
        </div>
      </div>
