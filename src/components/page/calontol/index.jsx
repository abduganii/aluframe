...
export default function ControllPage() {
  ...
  const { data, isLoading: isNewsLoading, fetchNextPage, hasNextPage } = useInfiniteQuery(
    ['sealants', params.get('page')],
    async () => await GetAllData("sealants", {
    ...
    <>
      <div>
        ...
        <div className="scrollList">
          ...
          />
          <GlobalForm handleSubmit={handleSubmit} reset={reset} url={'sealants'} onedataId={onedataId}>
            <AddInput
              type={"text"}
